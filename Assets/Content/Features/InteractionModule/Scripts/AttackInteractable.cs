...
namespace Content.Features.InteractionModule
{
    public class AttackInteractable : MonoBehaviour, IInteractable
    {
        ...
        [Inject] public void InjectDependencies(IEntityBehaviourFactory entityBehaviourFactory) =>
            _entityBehaviourFactory = entityBehaviourFactory;

        public void Interact(IEntity entity)
        {
            AttackEntityBehaviour attackEntityBehaviour =
                _entityBehaviourFactory.GetEntityBehaviour<AttackEntityBehaviour>();
