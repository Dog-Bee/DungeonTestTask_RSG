...
namespace Content.Features.AIModule.Scripts.Entity
{
    public class MonoEntity : MonoBehaviour, IEntity
    {
        ...
        [Inject] public void InjectDependencies(IEntityDataService entityDataService, IStorageFactory storageFactory,
            IEntityBehaviourFactory entityBehaviourFactory,PlayerHealthModel playerHealthModel)
        {
        ...
        private void Start()
        {
            ...
            _entityContext.EntityDamageable.SetHealth(_entityContext.EntityData.StartHealth,_entityType == EntityType.Player? _playerHealthModel : null);
